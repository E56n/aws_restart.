...
# Definir el diccionario base para los vehículos
myVehicle = {
    "vin": "<empty>",
    "make": "<empty>",
    "model": "<empty>",
...
# Mostrar las claves y valores iniciales del diccionario
...
with open('/home/ec2-user/environment/Labs/labSix/carFleet.csv') as csvFile:
...
# Imprimir el inventario de autos
